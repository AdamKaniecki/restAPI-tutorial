...
import pl.zajavka.infrastructure.petstore.auth.Authentication;
import pl.zajavka.infrastructure.petstore.auth.HttpBasicAuth;
import pl.zajavka.infrastructure.petstore.auth.HttpBearerAuth;
import pl.zajavka.infrastructure.petstore.auth.ApiKeyAuth;
import pl.zajavka.infrastructure.petstore.auth.OAuth;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2024-03-07T14:27:56.249902+01:00[Europe/Warsaw]")
